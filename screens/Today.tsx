  ...
  return (
    <View style={backgroundStyle}>
      ...
      <ScrollView
        ...
        {
          loading ? <Text>Loading...</Text> : articles.map((article) => (
            <TouchableOpacity onPress={() => navigation.navigate('WebView', { url: article.url, title: article.title })} key={article.url}>
              <ArticleCard {...article} />
            </TouchableOpacity>
          ))
        }
